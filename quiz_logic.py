...
class QuizLogic:
    ...
    def __init__(self, questions_file: str = "questions.json"):
        ...
        self.completed_difficulties = set()
        self.load_questions()
    ...
    def filter_questions(self) -> List[Dict[str, Any]]:
        ...
        if self.difficulty != "all":
            filtered = [q for q in filtered if q.get("difficulty", "easy") == self.difficulty]
    ...
    def next_question(self) -> bool:
        ...
        if self.current_question_index >= len(self.current_questions) and self.difficulty != "all":
